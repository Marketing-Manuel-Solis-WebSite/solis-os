    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="glass glow rounded-2xl p-8">
          ...
          <p className="text-sm text-gray-500 text-center mb-6">Accede a tu espacio de trabajo</p>
          ...
          <div className="relative my-6"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-d-border" /></div><div className="relative flex justify-center"><span className="bg-d-card px-3 text-xs text-gray-600">o</span></div></div>
